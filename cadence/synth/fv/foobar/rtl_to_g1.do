...
usage -auto -elapse
set log file fv/foobar/rtl_to_g1.log -replace
tclmode
...
add search path -library /ubc/ece/data/cmc2/kits/ncsu_pdk/FreePDK15/NanGate_15nm_OCL_v0.1_2014_06_Apache.A/front_end/timing_power_noise/CCS
read library -statetable -liberty -both  \
	NanGate_15nm_OCL_worst_low_conditional_ccs.lib
...
elaborate design -golden -root foobar -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/foobar/g1.v.gz
} else {
...
elaborate design -revised -root foobar
